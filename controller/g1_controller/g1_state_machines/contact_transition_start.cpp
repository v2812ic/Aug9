...
ContactTransitionStart::ContactTransitionStart(
  ...
  if (state_id_ == g1_states::kLFContactTransitionStart)
    util::PrettyConstructor(2, "LFContactTransitionStart");
  else if (state_id_ == g1_states::kRFContactTransitionStart)
...
void ContactTransitionStart::FirstVisit() {
  ...
  if (state_id_ == g1_states::kLFContactTransitionStart) {
    // stance foot lfoot
    std::cout << "g1_states::kLFContactTransitionStart" << std::endl;
    // =====================================================================
    ...
    // stance foot rfoot
    std::cout << "g1_states::kRFContactTransitionStart" << std::endl;
    // =====================================================================
    // task hierarchy manager initialize
    // =====================================================================
  ...
  if (ctrl_arch_->dcm_tm_->NoRemainingSteps()) {
    ...
    if (sp_->prev_state_ == g1_states::kDoubleSupportBalance) {
...
StateId ContactTransitionStart::GetNextState() {
  if (ctrl_arch_->dcm_tm_->NoRemainingSteps())
    ...
    if (state_id_ == g1_states::kLFContactTransitionStart) {
      ...
      return g1_states::kLFContactTransitionEnd;

    } else {
      sp_->stance_foot_ = g1_link::l_foot_contact;
      return g1_states::kRFContactTransitionEnd;
    }
  }
}
