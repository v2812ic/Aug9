...
SingleSupportSwing::SingleSupportSwing(StateId state_id,
  ...
  if (state_id_ == g1_states::kLFSingleSupportSwing)
    util::PrettyConstructor(2, "kLFSingleSupportSwing");
  else if (state_id_ == g1_states::kRFSingleSupportSwing)
...
void SingleSupportSwing::FirstVisit() {
  ...
  if (state_id_ == g1_states::kLFSingleSupportSwing) {
    std::cout << "g1_states::kLFSingleSupportSwing" << std::endl;
    ...
    std::cout << "g1_states::kRFSingleSupportSwing" << std::endl;
