...
ContactTransitionEnd_WBIC::ContactTransitionEnd_WBIC(
  ...
  if (state_id_ == g1_states_wbic::kLFContactTransitionEnd)
    util::PrettyConstructor(2, "LFContactTransitionEnd_WBIC");
  else if (state_id_ == g1_states_wbic::kRFContactTransitionEnd)
...
void ContactTransitionEnd_WBIC::FirstVisit() {
  ...
  if (state_id_ == g1_states_wbic::kLFContactTransitionEnd) {
    std::cout << "g1_states_wbic::kLFContactTransitionEnd" << std::endl;
    // =====================================================================
    ...
    std::cout << "g1_states_wbic::kRFContactTransitionEnd" << std::endl;
    // =====================================================================
    // contact max normal force manager initialize
    // =====================================================================
...
StateId ContactTransitionEnd_WBIC::GetNextState() {
  if (state_id_ == g1_states_wbic::kLFContactTransitionEnd)
    return g1_states_wbic::kLFSingleSupportSwing;
  else if (state_id_ == g1_states_wbic::kRFContactTransitionEnd)
    return g1_states_wbic::kRFSingleSupportSwing;
}
