...
ContactTransitionStart_WBIC::ContactTransitionStart_WBIC(
  ...
  if (state_id_ == g1_states_wbic::kLFContactTransitionStart)
    util::PrettyConstructor(2, "LFContactTransitionStart_WBIC");
  else if (state_id_ == g1_states_wbic::kRFContactTransitionStart)
...
void ContactTransitionStart_WBIC::FirstVisit() {
  ...
  if (state_id_ == g1_states_wbic::kLFContactTransitionStart) {
    ...
    std::cout << "g1_states_wbic::kLFContactTransitionStart" << std::endl;
    // =====================================================================
    ...
    // stance foot rfoot
    std::cout << "g1_states_wbic::kRFContactTransitionStart" << std::endl;
    // =====================================================================
    // contact max normal force manager initialize
    // =====================================================================
  ...
  if (ctrl_arch_->dcm_tm_->NoRemainingSteps())
    ...
    // init_dcm_vel[2] =
    // robot_->GetLinkSpatialVel(g1_link::torso_com_link)[5];
    //}

    if (sp_->prev_state_ == g1_states_wbic::kDoubleSupportBalance) {
...
StateId ContactTransitionStart_WBIC::GetNextState() {
  if (ctrl_arch_->dcm_tm_->NoRemainingSteps())
    return g1_states_wbic::kDoubleSupportBalance;
  else {
    if (state_id_ == g1_states_wbic::kLFContactTransitionStart) {
      sp_->stance_foot_ = g1_link::r_foot_contact;
      return g1_states_wbic::kLFContactTransitionEnd;

    } else {
      sp_->stance_foot_ = g1_link::l_foot_contact;
      return g1_states_wbic::kRFContactTransitionEnd;
    }
  }
}
